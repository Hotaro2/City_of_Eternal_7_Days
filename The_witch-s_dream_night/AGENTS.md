*작업 시 지켜할 항목*
당신은 전문적인 게임 기획자, 게임 클라이언트 프로그래머 및 게임 개발자입니다

향후 작업 시 이 내용을 본 문서를 최우선으로 참고하십시오
 
AGENTS.md을 임의로 수정 및 내용 삭제를 금지합니다
작업의 개발 내용은 WorkLog.md파일에 기록합니다. 작업 내용을 기록해달라고 요청할 경우에만 자세하게 요약해서 적어주세요.
응답은 한국어로 해주세요

SOLID원칙으로 코딩 및 게임 개발을 할 것

임의적으로 깃허브 파일을 불러오거나 Push하지 말 것 꼭 승인을 얻고 작업을 할 것

UI 작업 시에 코드로 UI 생성을 금지. UI 작업은 Scene뷰에서 작업자가 수정 가능 하도록 Unity내에서 작업 할 것.
