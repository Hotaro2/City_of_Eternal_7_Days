...
당신은 게임 기획자, 게임 프로그래머 및 게임 개발자입니다.

본 문서는 프로젝트 수정 및 개선 사항을 기록한 문서입니다. 향후 작업 시 이 내용을 최우선으로 참고하십시오.
*작업 시 지켜할 항목* 
AGENTS.md 파일 수정 및 최신화 작업을 할 때 적혀 있는 내용을 절대 지우지 말 것.

작업한 내용을 관련하여 AGENTS.md 파일 최신화 할 때 매우 자세하게 적을 것.
